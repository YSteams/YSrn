  ...
  render() {
    ...
    return (
       <Container>
                ...
                <Content style={{marginTop:-10}} >
                      ...
                      <View style={[styles.PersonalCenter,styles.PersonalContent]}>
                            ...
                            <View style={styles.PersonalCardMsg}>
                              ...
                              <Text onPress={() => {Actions.Pinfo({name: 'Brent'})}} style={styles.PersonalCardText}>123</Text>
              ...
              <Text onPress={() => {Actions.Pnews({name: 'Brent'})}}>动态</Text>
              <Text onPress={() => {Actions.Pask({name: 'Brent'})}}>问答</Text>
                          </View>
                    </View>  
              ...
              <TouchableHighlight onPress={() => {Actions.Pmyresume({name: 'Brent'})}}>
                         ...
                         <TouchableHighlight onPress={() => {sco.ShowInvite(true)}}>
                            <CardItem style={styles.PersonalTypeCardItem}>
                             ...
                             <TouchableHighlight onPress={() => {Actions.Phelplist({name: 'Brent'})}}>
                             <CardItem style={styles.PersonalTypeCardItem}>
